...
import 'bravo_reaction_model.dart';
export 'bravo_reaction_model.dart';

class BravoReactionWidget extends StatefulWidget {
  const BravoReactionWidget({
    super.key,
    required this.id,
  });
  ...
  static String routeName = 'BravoReaction';
  static String routePath = '/bravoReaction';

  @override
  State<BravoReactionWidget> createState() => _BravoReactionWidgetState();
}

class _BravoReactionWidgetState extends State<BravoReactionWidget>
    with TickerProviderStateMixin {
  late BravoReactionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BravoReactionModel());
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              fadeOutDuration:
                                                  Duration(milliseconds: 400),
                                              imageUrl:
                                                  'https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWtsaDB6Y3Q3emF1aGJ6YmFvMDNhc2hwYTRhc2N5dm5sMWwyNm1qOSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/aRwTbtIFhkmWFdogcb/giphy.webp',
                                              width: 326.0,
                                              height: 303.0,
