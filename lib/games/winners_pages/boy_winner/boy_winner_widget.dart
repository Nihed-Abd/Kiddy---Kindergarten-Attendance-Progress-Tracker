...
import 'boy_winner_model.dart';
export 'boy_winner_model.dart';

class BoyWinnerWidget extends StatefulWidget {
  const BoyWinnerWidget({
    super.key,
    required this.id,
  });
  ...
  static String routeName = 'BoyWinner';
  static String routePath = '/boyWinner';

  @override
  State<BoyWinnerWidget> createState() => _BoyWinnerWidgetState();
}

class _BoyWinnerWidgetState extends State<BoyWinnerWidget>
    with TickerProviderStateMixin {
  late BoyWinnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoyWinnerModel());
